...
/* ------------------------------------------------------------------ */
/*  Dedup helper (avoids native Map constructor conflict)              */
/* ------------------------------------------------------------------ */
...
function NeighborhoodRectangle({
  ...
  return (
    <AdvancedMarker position={{ lat: centerLat, lng: centerLng }} zIndex={2} clickable={false}>
      <div
...
export function AreaMap({
  ...
  const [selectedNeighborhood, setSelectedNeighborhood] = useState<NeighborhoodOverlay | null>(null)
        ...
        {selectedNeighborhood && selectedNeighborhood.bounds_ne_lat && selectedNeighborhood.bounds_sw_lat && selectedNeighborhood.bounds_ne_lng && selectedNeighborhood.bounds_sw_lng && (
          ...
          >
            <Link
              ...
              className="block p-1 no-underline text-foreground"
            >
              <p className="font-semibold text-sm">{selectedNeighborhood.name}</p>
              <p className="text-xs text-muted-foreground mt-0.5">
...
/* ------------------------------------------------------------------ */
/*  Map legend (exported for use alongside AreaMap)                     */
/* ------------------------------------------------------------------ */
