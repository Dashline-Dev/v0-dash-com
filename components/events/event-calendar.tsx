...
import { hebrewDayStr, hebrewMonthYearStr } from "@/lib/hebrew-date"
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col">
          ...
          <span
            ...
            lang="he"
          >
            {hebrewMonthYearStr(new Date(year, month - 1, 15))}
          </span>
        </div>
      ...
      <div className="rounded-xl border border-border bg-card overflow-hidden">
        ...
        <div className="grid grid-cols-7">
          ...
          {Array.from({ length: firstDay }).map((_, i) => (
            <div key={`empty-${i}`} className="h-[72px] md:h-[80px] border-b border-r border-border bg-muted/30" />
          ))}
          ...
          {Array.from({ length: daysInMonth }).map((_, i) => {
            ...
            return (
              <button
                ...
                className={`h-[72px] md:h-[80px] border-b border-r border-border flex flex-col items-center justify-start pt-1.5 gap-0 transition-colors text-left w-full
